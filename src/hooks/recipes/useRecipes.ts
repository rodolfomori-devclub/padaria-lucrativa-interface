...
import type { AddRecipeInputData, CreateRecipeData, Recipe, UpdateRecipeData } from '~/types/recipe'
...
export const useRecipes = () => {
    ...
    const updateRecipeMutation = useMutation({
        mutationFn: async ({ id, data }: { id: string; data: UpdateRecipeData }): Promise<Recipe> => {
    ...
    const addIngredientMutation = useMutation({
        mutationFn: async ({ recipeId, data }: { recipeId: string; data: AddRecipeInputData }): Promise<Recipe> => {
