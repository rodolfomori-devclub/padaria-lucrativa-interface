...
export function FinancialIndicators({ financialData, isLoading = false }: FinancialIndicatorsProps) {
    const indicators = [
        {
    ...
    return (
        <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Indicadores Financeiros</h2>
            <p className="text-sm text-gray-600 mb-6">
                Valores e percentuais calculados com base na previsão mensal
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {indicators.map((indicator) => {
                    const isCMV = indicator.label === "Compra do Mês";
